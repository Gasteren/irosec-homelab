---
title: "Proxmox Setup"
description: "Proxmox VE is the hypervisor running the irosec homelab. It hosts all virtual machines and provides snapshot, backup,..."
sidebar:
  order: 1
---
...
| VM ID | Name | OS | Role |
|---|---|---|---|
| 100 | Dockers | Ubuntu 22.04 LTS | All Docker hosted services |
| 101 | Hassio | Home Assistant OS (Buildroot) | Smart home automation |
