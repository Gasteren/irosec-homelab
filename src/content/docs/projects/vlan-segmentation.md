---
title: "Project: VLAN Segmentation"
...
A flat network where a smart vacuum, a vehicle integration, a media server, and a password manager all share the same broadcast domain is a significant security risk. If any one device is compromised, an attacker has direct network access to everything else. VLAN segmentation eliminates that.
...
|---|---|---|---|
| Server Network - JARVIS | 1 | 10.10.1.0/24 | Proxmox, Docker VM, self-hosted services |
| Guest Network | 2 | 10.10.2.0/24 | Isolated guest WiFi |
| IoT Devices | 3 | 10.10.3.0/24 | Smart home devices, Home Assistant integrations |
| Main Network - FRIDAY | 4 | 10.10.4.0/24 | Trusted personal devices |
...
![VLAN setup](https://img.irosec.com/u/Ybb4mG.jpg)
